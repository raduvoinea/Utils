...
alias grepsvn='grep -rI --exclude-dir=".svn"'
alias rgrep='grep -r'

alias scr='screen -U -d -R'
alias sudo='sudo '              # preserve aliases when sudoing

#my wstaging websites
alias rvjd='cd /perfectworld/vhosts/rv.jd.perfectworld/'
alias rvfw='cd /perfectworld/vhosts/rv.fw.perfectworld/'
alias rvoff='cd /perfectworld/vhosts/rv.offers.perfectworld/'
alias rvreg='cd /perfectworld/vhosts/rv.register.perfectworld/'
alias rvw='cd /perfectworld/vhosts/rv.www.perfectworld/'
alias rvacc='cd /perfectworld/vhosts/rv.account.perfectworld/'
alias rvtick='cd /perfectworld/vhosts/rv.ticket.perfectworld/'
alias rvpwi='cd /perfectworld/vhosts/rv.pwi.perfectworld/'
alias rvwoi='cd /perfectworld/vhosts/rv.woi.perfectworld/'
alias cpv='cd /perfectworld/vhosts/'
alias cpl='cd /perfectworld/logs/'
alias vh='cd /etc/apache2/vhosts.d/'
